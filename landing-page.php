...
<body>
    <section class="land-box">
        ...
        <div class="verification-ctns">
           <a class="signup-btn" href="Authentication/Sign-up.php">Sign up</a>
           <p><span class="already">&nbsp;&nbsp;&nbsp;&nbsp;Already have account?</span>  &nbsp; <a class="login-btn" href="Authentication/Login.php">Login</a>&nbsp;&nbsp;&nbsp;&rightarrow;</p>
        </div>
